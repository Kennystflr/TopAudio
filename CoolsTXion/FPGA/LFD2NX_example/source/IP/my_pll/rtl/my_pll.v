...
*******************************************************************************/
(* ORIG_MODULE_NAME="my_pll", LATTICE_IP_GENERATED="1" *) module my_pll (clki_i, 
        rstn_i, 
        clkop_o, 
        lock_o) ;
    input clki_i ; 
    ...
    output clkop_o ; 
    output lock_o ; 
    my_pll_ipgen_lscc_pll #(.INTFBKDEL_SEL("DISABLED"),
            ...
            .FRAC_N_EN(0),
            .FBK_MODE("INTCLKOP"),
            .FBCLK_DIVIDER_ACTUAL_STR("5"),
            .SSC_N_CODE_STR("0b000000101"),
...
// Module : lscc_pll
//==========================================================================
module my_pll_ipgen_lscc_pll #(parameter FVCO = 800.0, 
    ...
    generate
        if ((APB_EN == 1)) 
            begin : gen_apb
                ...
                ///
                my_pll_ipgen_lscc_apb2lmmi #(.DATA_WIDTH(8),
                        .ADDR_WIDTH(8),
                ...
                if (APB_SOFT_REG_EN) 
                    begin : gen_csr
                        wire unused_w ; 
                        my_pll_ipgen_pll_csr u_csr (// Inputs
                                .clk_i(apb_pclk_i), 
                                    .rst_n_i(apb_preset_n_i), 
...
// Module : pll_csr
//==========================================================================
(* LATTICE_IP_MODULE=1 *) module my_pll_ipgen_pll_csr #(parameter SIMULATION = 0) (
    //--begin_param--
    //----------------------------
    // Parameters
    //----------------------------
...
//==========================================================================
module my_pll_ipgen_lscc_apb2lmmi #(parameter DATA_WIDTH = 32, 
